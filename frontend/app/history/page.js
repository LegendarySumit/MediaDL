    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDark
      ...
      <div className={`border-b backdrop-blur-sm transition-colors duration-300 ${isDark
        ...
        <div className="max-w-6xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-4 xs:py-5 sm:py-6">
          <div className="flex items-center justify-between flex-wrap gap-3 xs:gap-4">
            <div>
              <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold bg-linear-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">📋 Downloads</h1>
            </div>
            <Link
              href="/"
              className={`px-3 xs:px-4 py-1.5 xs:py-2 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg transition font-semibold flex items-center gap-1.5 xs:gap-2 text-xs xs:text-sm !text-white ${isDark
      ...
      <div className="max-w-6xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-5 xs:py-6 sm:py-8">
        <div className={`rounded-lg backdrop-blur-sm p-6 xs:p-8 sm:p-12 text-center transition-colors duration-300 ${isDark
          ...
          <Link
            href="/"
            className={`inline-block px-4 xs:px-5 sm:px-6 py-2 xs:py-2.5 sm:py-3 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-semibold transition text-xs xs:text-sm sm:text-base !text-white ${isDark
                ? 'border border-blue-500/30 shadow-lg shadow-blue-500/20'
